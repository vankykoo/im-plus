...
| 笔记本 | Windows | `192.168.30.1` | 部署冗余实例用于测试 |
...
| | 笔记本 (`192.168.30.1`) | 1 | 8080 |
| **im-message-server** | 台式机 (`192.168.10.2`) | 1 | 8100 |
| | 笔记本 (`192.168.30.1`) | 1 | 8100 |
