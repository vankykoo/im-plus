package com.vanky.im.server.mq;

import com.vanky.im.common.enums.ClientToClientMessageType;
import com.vanky.im.common.protocol.ChatMessage;
import com.vanky.im.server.processor.GroupMsgProcessor;
import com.vanky.im.server.processor.PrivateMsgProcessor;
...
public class ConversationMessageConsumer implements MessageListenerConcurrently {
    ...
    private void processMessage(ChatMessage chatMessage, String conversationId) {
        try {
            ...
            // 根据消息类型分发处理
            if (messageType == ClientToClientMessageType.P2P_CHAT_MESSAGE.getValue()) {
                // 处理私聊消息
